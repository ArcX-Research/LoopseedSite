...
pub const EXPERIMENTS: &[Experiment] = &[
    Experiment {
        ...
        cells: 384,
        design: &[
            "A corpus of 60 structured examples passed exact checks and separate AI review. Its fixed split supplied 48 training, six validation and six test examples, with every represented family retained in training. Training used an isolated copy; the checked live database remained unchanged.",
        ...
        gates: &[
            ...
            Gate { name: "instrument's information-leak checks passed", passed: true },
        ...
        reading: &[
            ...
            "Four families scored 0 of 8 in every condition. Later inspection identified ambiguous nested instructions in those 32 prompts. Excluding them descriptively gives 94 of 96 candidate successes; this post-hoc subset does not replace the frozen 94-of-128 endpoint.",
    ...
    Experiment {
        id: "transfer-clean",
        title: "Clean transfer: better answers on new parameter instances",
        date: "2026-09-04",
        run: "claim-transfer-clean-2026-09-03T170409Z",
        instrument: "claim-method-transfer-v2",
        cells: 1024,
        design: &[
            "The clean corpus contained 60 accepted examples: 48 training, six validation and six test. A separate evaluation then used the 64 fresh parameter instances below. All sixteen families were represented in training; family coverage was uneven, with one to ten accepted examples per family across the whole corpus.",
            ...
            "64 tasks covered four new parameter sets in each of 16 predefined mathematical families. The test excluded exact tasks used in the earlier stage, the focused follow-up and the historical source data. This exclusion does not establish that the base model's pretraining contained no related mathematics or templates.",
        ...
        gates: &[
            ...
            Gate { name: "instrument leak checks passed; checked live database unchanged", passed: true },
        ],
        ...
        reading: &[
            ...
            "The candidate passed the primary test while the matched placebo scored zero. This supports an advantage from the correct prompt–reply pairings in this setup. It does not determine whether the adapter learned a general algorithm or effective completion of familiar templates. The placebo's strict-grammar successes show that output constraints also influence performance.",
            "Zero paired losses against the base model and placebo means no successful control answer became a candidate failure. Both controls scored zero on this set, so that comparison cannot establish retention of other abilities. Against the prediction adapter, five successful answers were retained and 38 more passed.",
            "Supplying the calculation steps reduced the candidate's score to 4 of 64, compared with 43 under names-only prompts. A mismatch with the training format and more length-limit failures are possible explanations; this diagnostic does not isolate their relative contributions.",
            "Four candidate replies passed the numerical checks but did not perform the requested calculation. A separate AI reviewer rejected them with condition labels withheld. Exact calculation and compliance with the task specification need separate checks; the reviewer itself is not an independent replication.",
            "The 64 tasks are grouped within sixteen related families. The reported statistical calculation treats task pairs as independent and does not account for clustering or variation across independently trained adapters. The original numerical result is preserved; its scope is this candidate and evaluation protocol.",
        ],
        hashes: &[
            ...
            Hash { label: "clean dataset manifest (48 / 6 / 6 split)", value: "11f236a8c444d559c6920b1a61b10b70cc336cea2d5d5cfede9934528d6bdaf6" },
